...
<template>
  <section id="article-stoicism" class="bg-white dark:bg-gray-900 w-full pb-24 mb-0">
    <div class="w-full pb-40 pt-20 bg-primary-600 px-4 sm:px-40 bg-local bg-no-repeat bg-center bg-blend-multiply" :style="'background-image: url(' + cloudinaryUrl + meta?.backgroundImage + ')'">
